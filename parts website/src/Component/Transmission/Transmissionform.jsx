...
export default function EngineForm({
  ...
  return (
    <div className="container">
      ...
      <div className="transmission-form  container mb-5 mt-4" id="trans-form">
        <div className="row">
          <div className="col-lg-6">
            <span className="me-3 text-black fw-bold fs-4">Search Your Transmission Here</span>
          </div>
        </div>
              ...
              <div className="row align-items-center">
                <div className="col-lg-6">
                  <div className="find-transmission__content">
                    Auto Parts Leads Transmissions provides you the high quality
                    used & remanufactured Transmissions. Auto Parts Leads
                    ...
                    before we deliver it to you. Auto Parts Leads transmissions
                ...
                <div className="col-lg-6">
                  ...
                  >
                    ...
                    <img src="/assets/find-transmission-2.jpg" alt="" className="img-fluid"/>
                ...
                <div className="col-lg-6">
                  <div className="find-transmission__content">
                    <p>
                      ...
                      no extra cost. Auto Parts Leads Transmissions team offer you
