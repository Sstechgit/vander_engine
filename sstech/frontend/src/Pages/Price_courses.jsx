            ...
            <div className="col-md-12">
              <div className="row  m-3 border">
                ...
                <div className="col-lg-8 d-flex flex-column justify-content-center">
                  <h4 style={{color:"#ff9c00"}} className="fw-bold fs-2">At a Reasonable Cost</h4>
                  <p>
                    Advancing your career shouldn't be expensive, which is why
                    we’ve designed this exceptional program to be affordable for
                    you.
                  </p>
                  <h4 style={{color:"#ff9c00"}} className="fw-bold fs-2">Duration: 6 Months</h4>
                </div>
              </div>
            </div>
          </div>
