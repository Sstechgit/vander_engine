...
const JobForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
          const response = await fetch('https://newbackend.sstechservices.net/api/users', {
            method: 'POST',
    ...
    return (
        <form className="responsive-form" onSubmit={handleSubmit}>
            ...
            {loading && <div className="loader">Submitting...</div>} {/* Loader component */}
            ...
            <div className="form-group">
                <label>Relevant Experience: <span>*</span> </label>
                <input type="number" name="relevantExperience" required value={formData.relevantExperience} onChange={handleChange} />
            </div>
            <div className="form-group">
                <label>Current Salary: <span>*</span> </label>
                <input type="number" name="currentSalary" required value={formData.currentSalary} onChange={handleChange} />
            </div>
            <div className="form-group">
                <label>Expected Salary: <span>*</span> </label>
                <input type="number" name="expectedSalary" required value={formData.expectedSalary} onChange={handleChange} />
            </div>
            <div className="form-group">
                <label>Notice Period: <span>*</span> </label>
                <input type="text" name="noticePeriod" required value={formData.noticePeriod} onChange={handleChange} />
            </div>
            <div className="form-group">
