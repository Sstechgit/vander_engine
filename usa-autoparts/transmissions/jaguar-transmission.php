...
<head>
    ...
    <title>Jaguar-Transmissions</title>
...
<body>
    ...
    <div style="width:100%;height:100%;overflow-x:hidden;">
        ...
        <div class="formCont">
            ...
            <div class="rightForm">
                <p>Genuine Used Jaguar-Transmissions With Warranty</p>
                <div class="iconTable">
                    <div>
        ...
        <div class="pageCont">
            <div class="leftPage">
                <p>
                <h1>Used Jaguar Transmissions for Sale -USA Auto Parts</h1>
                </p>
                <p>USA Auto parts is your leading provider of high-quality used transmissions in the United States. We
                    are
                    specializing in providing used Jaguar transmissions to ensure your vehicle performance. USA Auto
                    Parts is a
                    trusted provider of used transmissions in the USA. Our used Jaguar transmission is rigorously
                    inspected and
        ...
        <div class="TileCont" style="background-image:url('../images/honda-bg.png')">
            <div class="tileParent">
                <div class="tileDiv">
                    <p>
                    <h2>Benefits of Buying Used Jaguar Transmissions from USA Auto Parts: </h2>
                    </p>
                    ...
                    <p> <b>Quality Assurance:</b> All our used Jaguar transmissions undergo rigorous testing and
                        inspection to
                        ensure they meet the highest standards of quality and performance.

                    </p>
                    <p> <b> Wide Selection: </b> We offer a diverse inventory of transmissions for various Jaguar
                        models, ensuring
        ...
        <div class="pageCont" style="margin:2rem 0;">
            ...
            <div class="leftPage">
                <p>
                <h3>Jaguar Transmission Models Available:</h3>
                </p>
                <p>Jaguar ZF 6HP26, Jaguar ZF 6HP28, Jaguar ZF 8HP70, Jaguar ZF 8HP45</p>
            </div>
            <div class="rightPage">
