...
<head>
    ...
    <title>Porsche-Transmissions</title>
...
<body>
    ...
    <div style="width:100%;height:100%;overflow-x:hidden;">
        ...
        <div class="formCont">
            ...
            <div class="rightForm">
                <p>Genuine Used Porshe-Transmissions With Warranty</p>
                <div class="iconTable">
                    <div>
        ...
        <div class="pageCont">
            <div class="leftPage">
                <p>
                <h1> Used Porsche Transmissions For Sale - USA Auto Parts</h1>
                </p>
                <p>Usa auto parts is one of the most trusted seller of used PorscheTransmissions. We have a wide range
                    of
                    second hand PorscheTransmission that you can buy at usa auto parts. Our transmissions are highly
                    tested
                    and inspected before delivering it to you. The transmissions that we sell are sourced from the
                    trusted
                    partners only. We also offer you upto 5 years warranty on our used PorscheTransmission. Our
                    dedicated
                    team is always ready to help you find the best used Porsche transmission for your car.
                </p>
        ...
        <div class="TileCont" style="background-image:url('../images/honda-bg.png')">
            <div class="tileParent">
                <div class="tileDiv">
                    <p>
                    <h2>Benefits of purchasing used Porsche Transmissions from USA Auto Parts</h2>
                    </p>
                    <p> <b> Cost Savings: </b> Significant savings compared to purchasing new transmissions, helping you
                        stay
                        within budget without compromising on quality.
                    </p>
                    <p> <b> Quality Assurance:</b>Each transmission undergoes rigorous testing and inspection to ensure
                        optimal
                        performance and reliability, backed by our commitment to quality.
                    </p>
                    <p> <b>Wide Selection:</b>We offer transmissions for a variety of Porsche models, ensuring you can
                        find the
                        perfect match for your vehicle's specifications and needs.
                    </p>
                    <p> <b>Nationwide Availability: </b>We deliver across all states in the USA, making it convenient
                        for you to
                        get the transmission you need, wherever you are.
                    </p>
                    <p> <b>Dedicated Customer Support: </b> Our knowledgeable team is here to assist you throughout your
                        purchase journey, providing guidance and answering any questions you may have.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="pageCont" style="margin:2rem 0;">
            ...
            <div class="leftPage">
                <p>
                <h3>Porsche Transmissions Models Available:</h3>
                </p>
                <p>Porsche 911, Porsche Boxster, Porsche Cayman, Porsche Cayenne, Porsche Panamera, Porsche Macan,
                    Porsche
                    Taycan
                </p>
            </div>
