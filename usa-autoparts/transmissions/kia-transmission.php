...
<body>
    ...
    <div style="width:100%;height:100%;overflow-x:hidden;">
        ...
        <div class="formCont">
            ...
            <div class="rightForm">
                <p>Genuine Used Kia-Transmissions With Warranty</p>
                <div class="iconTable">
                    <div>
        ...
        <div class="pageCont">
            <div class="leftPage">
                <p>
                <h1>Used Kia Transmissions for Sale -USA Auto Parts</h1>
                </p>
                <p>USA Auto parts is your leading provider of high-quality used transmissions in the United States. We
                    are
                    specializing in providing used Kia transmissions to ensure your vehicle performance. USA Auto Parts
                    is a
                    trusted provider of used transmissions in the USA. Our used KiA transmission is rigorously inspected
                    and
        ...
        <div class="TileCont" style="background-image:url('../images/honda-bg.png')">
            <div class="tileParent">
                <div class="tileDiv">
                    <p>
                    <h2>Benefits of Buying Used Kia Transmissions from USA Auto Parts: </h2>
                    </p>
                    ...
                    <p> <b>Quality Assurance:</b> All our used Kia transmissions undergo rigorous testing and inspection
                        to
                        ensure they meet the highest standards of quality and performance.

                    </p>
                    <p> <b> Wide Selection: </b> We offer a diverse inventory of transmissions for various Kia models,
                        ensuring
