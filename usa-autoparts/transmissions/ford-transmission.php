...
<head>
    ...
    <title>Ford-Transmissions</title>
...
<body>
    ...
    <div style="width:100%;height:100%;overflow-x:hidden;">
        ...
        <div class="formCont">
            ...
            <div class="rightForm">
                <p>Genuine Used Ford-Transmissions With Warranty</p>
                <div class="iconTable">
                    <div>
        ...
        <div class="pageCont">
            <div class="leftPage">
                <p>
                <h1>Used Ford Transmissions for Sale-USA Auto Parts</h1>
                </p>
                <p>Find the perfect used ford transmission at Usa auto parts. Usa auto parts is one of the best
                    remanufactured
                    Ford transmission sellers in the United States. If you are also looking to find the perfect match
                    for your
                    ford car transmission then you are at the right place. We have a wide range of used ford
                    transmission. Our
                    dedicated technical team will help you to find the perfect match for Ford vehicles. Our used ford
                    transmissions are mainly sourced from the trusted sellers only. The second hand ford transmissions
                    that we
                    sell give high performance and are reliable.
        ...
        <div class="TileCont" style="background-image:url('../images/honda-bg.png')">
            <div class="tileParent">
                <div class="tileDiv">
                    <p>
                    <h2>Benefits of Buying Used Ford Transmissions from USA Auto Parts:</h2>
                    </p>
                    ...
                    <p> <b>Quality Assurance:</b> All our used Ford transmissions undergo rigorous testing and
                        inspection to ensure
                        they meet the highest standards of quality and performance.

                    </p>
                    <p> <b> Wide Selection: </b> We offer a diverse inventory of transmissions for various Ford models,
                        ensuring you
        ...
        <div class="pageCont" style="margin:2rem 0;">
            ...
            <div class="leftPage">
                <p>
                <h3>Ford Transmission Models Available:</h3>
                </p>
                <p>Ford 4R70W, Ford 4R100, Ford 5R110W, Ford 6R60, Ford 6R80, Ford 10R80
