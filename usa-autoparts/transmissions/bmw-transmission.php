...
<body>
    ...
    <div style="width:100%;height:100%;overflow-x:hidden;">
        ...
        <div class="formCont">
            ...
            <div class="rightForm">
                <p>Genuine Used BMW-Transmissions With Warranty</p>
                <div class="iconTable">
                    <div>
        ...
        <div class="pageCont">
            <div class="leftPage">
                <p>
                <h1>Used BMW Transmission for Sale-USA Auto Parts</h1>
                </p>
                <p>USA Auto Parts is your leading provider of high-quality used Transmission in the United States. We
                    specialize
                    in providing used BMW transmissions to ensure your vehicle's performance. USA Auto Parts is a
                    trusted
                    provider of used engines in the USA. Our used BMW transmissions are rigorously inspected and tested
                    to
        ...
        <div class="pageCont" style="margin:2rem 0;">
            ...
            <div class="leftPage">
                <p>
                <h3>Why Choose a Used BMW Transmission?</h3>
                </p>
                <p>When you opt for a used BMW transmission from USA Auto Parts, you’re investing in a product that
                    combines
