...
<body>
    ...
    <div style="width:100%;height:100%;overflow-x:hidden;">
        ...
        <div class="formCont">
            ...
            <div class="rightForm">
                <p>Genuine Used Volvo-Engine Parts With Warranty</p>
                <div class="iconTable">
                    <div>
        ...
        <div class="pageCont">
            <div class="leftPage">
                <p>
                <h1>Volvo Used Engine for Sale - USA Auto Parts</h1>
                </p>
                <p>Welcome to USA Auto Parts, your trusted source for high-quality used Volvo engines in the
                    United States. We pride ourselves on offering top-notch used engines that deliver exceptional
                    performance and reliability. If you're searching for a used Volvo engine for sale, look no
        ...
        <div class="TileCont" style="background-image:url('../images/jeep-bg.webp');">
            <div class="tileParent">
                <div class="tileDiv">
                    ...
                    <p>As a trusted seller of used engines in the United States, we stand by the quality of our
                        products.
                        Our used Volvo engines are thoroughly inspected for performance and durability. Whether
                        you're replacing a worn-out engine or upgrading your vehicle, you can rely on our engines to
                        deliver the performance you need.</p>
                </div>
            </div>
        </div>
        <!-----------------third-section------------------------->
        <div class="pageCont">
            <div class="leftPage">
                ...
                <p>Navigating the market for a used engine can be daunting, but we're here to make the process
                    ...
                    exact used Volvo engine for sale that fits your requirements.</p>
            </div>
            <div class="rightPage">
        ...
        <div class="TileCont" style="background-image:url('../images/slide-1-bg.jpg');justify-content: flex-start;">
            <div class="tileParent" style="width: 60%; ">
                <div class="tileDiv">
                    <p>
                    <h3>Why choose our used Volvo engines?</h3>
                    </p>
                    <p>Opting for a used Volvo engine is a smart and economical choice. At USA Auto Parts, we
                        meticulously inspect and test each engine to ensure it meets our stringent quality standards.
                        Our used Volvo engines are no exception. They provide the power, efficiency, and
                        reliability you expect from volvo, at a fraction of the cost of a new engine.
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="container">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="child">
            Volvo 120 series Engines
         </div>
            </div>
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="child">
            Volvo 140 series Engines
         </div>
            </div>
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="child">
