...
<script>
  ...
  gtag('config', 'AW-11152279745');
    ...
    <title>Used & Remanufactured Engine for Sale</title>
    <meta name="description" content="find used & remanufactured engines for sale at Usaauto-parts. One of the trused supplier of rebuilt engines in United States with 5 yrs warranty. Free shipping">
    <link rel="canonical" href="https://usaauto-parts.com/used-engines.php">
    ...
    <style>
        *{
        ...
        .primaryHero::before {
            ...
            inset: 0;
            z-index: -1;
            background: url("./images/slide-1-bg.jpg") no-repeat center center/cover;
        }
        .row{
        ...
        * {
        ...
        .leftForm .flexCol select,
        .leftForm .flexCol input {
            color: #fff;
            border-bottom: 1px solid #fff;
        }

        .leftForm .flexCol input::placeholder {
            color: #fff;
        }
        form {
            /*padding: 1rem;*/
...
<?php include 'popup.php';?>
    ...
    <div class="wrap1">
        <div class="underline modUnderline">
            <p id="Head" class="changeText">Find your Engine</p>
                                ...
                                <div class="flexRow">
                                    ...
                                    <div class="flexCol">
                                        ...
                                        <input id="phone" size="20" maxlength="12" minlength="10" aria-required="true"
                                            aria-invalid="false" placeholder="Enter Phone" value="" type="tel"
                                            name="phone" required />
                                    </div>
                                    <div class="flexCol email">

                                        <input id="email" size="20" id="tel-915-contact-no" aria-required="true"
                                            aria-invalid="false" placeholder="Enter Email" value="" type="email"
                                            name="email" required />
                                    </div>
                                    <div class="centerBtn">
    ...
    <div class="line modifyLine"></div>
    <div class="wrap1 modifyWrap">
        ...
        <div class="wrapPage">
            <div class="underline">
                <p id="Head2" class="changeText">About All Our Used And Remanufactured Engines</p>
            ...
            <div class="row page WrapText " style=" justify-content:center; align-items:center;">
                <div class="right col-lg-6">
                    <p>At Usa Auto Parts LLC, we provide you high quality remanufactured engines that are fully
                        processed and refurbished. Our dedicated mechanical team checks the quality of every
                        used motors
                        and monitors its performance before delivering it to you. We promise to provide you with
                        engines that exceed OEM specifications and outperform factory counterparts.</p>
                    <p>
                        As we are one of the most trusted sellers of remanufactured engines, most of our rebuilt
                        engines are covered by an impressive 5-years unlimited mileage warranty. Usa Auto Parts
                        always have a stock of used engines and provide many varieties of second hand motor
                        engines
                        that make it easy for you to select and get it easily at your door steps. We ensure the
                        perfect engine that fits your vehicle. Despite our professional approach, we offer
                        competitive pricing and a price match guarantee. If you find a better price from a local
                        or
                        online rebuilt engine supplier, simply inform us, and we’ll match it with a
                        superior-quality
                        engine.
                    </p>
                    <p>
                        whatever you are looking for, like a used engine or a transmission for replacement, Usa
                        auto
                        parts is one of the best second hand motor engines solutions provider in the US for all
                        your
                        needs. Usa auto parts is industry leader in providing remanufactured engines and
                        transmissions
                    </p>
                </div>
                <div class="left col-lg-6">
                    <img src="./images/engine2.webp" alt="" class="engine-img">
                </div>
            </div>
        </div>
    ...
    <p class="subHead changeText">Providing All Makes And Models Of Quality Auto Parts in USA</p>

    <div class="wrap-carousel changeBg">
        <div class="carousel-container-1">
            <img src="./images/benz.png" class="benz child-1" alt="">
            <img src="./images/BMW.png" class="BMW child-1" alt="">
            <img src="./images/cadillac.png" class="cadillac child-1" alt="">
            <img src="./images/chevy.png" class="chevy child-1" alt="">
            <img src="./images/ford.png" class="ford child-1" alt="">
            <img src="./images/honda.png" class="honda child-1" alt="">
            <img src="./images/hyundai.png" class="hyundai child-1" alt="">
            <img src="./images/jeep.png" class="jeep child-1" alt="">
            <img src="./images/kia.png" class="kia child-1" alt="">
            <img src="./images/lexus.png" class="lexus child-1" alt="">
            <img src="./images/mazda.png" class="mazda child-1" alt="">
            <img src="./images/nissan-1.png" class="nissan child-1" alt="">
            <img src="./images/toyota.png" class="toyota child-1" alt="">
            <img src="./images/vw-1.png" class="vw-1 child-1" alt="">
        </div>
    </div>
    <div class="underline modUnderline">
        <p id="Head" class="changeText" style="color:#fff;">Find your Engine</p>
    ...
    <form action="mail.php" method="POST" style="display:none">
        <div class="flexRow">
            <div class="flexCol">

                <select id="year" aria-required="true" aria-invalid="false" name="year" required>
                    <option value="">- Select Year -</option>
                    <option value="1990">1990</option>
                    <option value="1991">1991</option>
                    <option value="1992">1992</option>
    ...
    <div class="WrapText">
        <p>
            <b>USA Auto Parts provides </b> the widest range of 100% genuine and top-quality Used & Remanufactured Engines find all
            kind of
            car
            engine. Here you can find V4 Engine, V6 Engine, V8 Engine, Used Engine, Used
            Motors, Automatic Engine, 4 Cylinder Engine, 6 Cylinder Engine, M52 Engine, M30 Engine, S62
            Engine,
            V12 Engine, Acura Engine, Audi, Engine, BMW Engine, Buick Engine, Chevrolet Engine, Chrysler
            Engine,
            Dodge Engine, Ford Engine, Fiat Engine, Honda Engine, Hummer Engine, Hyundai Engine,
            Isuzu Engine, Jaguar Engine, Jeep Engine, Kia Engine, Lexus Engine, Lincoln Engine, Mazda
            Engine,
            Mercedes Engine, Mini Engine, Mitsubishi Engine, Nissan Engine, Oldsmobile Engine, Pontiac
            Engine,
            Porsche Engine, Saab Engine, Saturn Engine, Subaru Engine, Suzuki Engine, Toyota Engine,
            Volkswagen
            Engine, Cadillac Engine, GMC Engine, Infinite Engine, Land Rover Engine, Mercury Engine,
            Plymouth
            Engine, Scion Engine.
        </p>
    </div>
