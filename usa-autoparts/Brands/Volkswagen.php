...
<?php include "../popup.php"?>
    ...
    <?php include "../header/header.php"; ?>
        ...
        <div class="tailHeader">
            <span><a href="../index.php">Home</a>/<span>Volkswagen</span></span>
        </div>
        <!-- form -->
        <div class="formCont">
            <div class="leftForm">
            ...
            <div class="rightForm">
                <p>Quality Volkswagen Car Parts for Sale: Upgrade Your Ride Today!</p>
                <div class="iconTable">
                    <div>
        ...
        <div class="pageCont">
            <div class="leftPage">
                <p>
                    Top Grade Used Volkswagen Parts For Sale Nearby
                </p>
                <p>
                    Stressed about running to different shops for different auto parts of your car and searching for one
                    one-stop shop? USA Auto Parts is here to solve your problem. We are the hub of all the auto parts
                    including engines, transmission, steering wheels, dashboard, airbags, etc. Auto Parts from bumper to
                    wheels are all you can get in USA Auto Parts parts store for any car model.
                </p>
                <p>If you are searching for used Volkswagen parts near me, then visit us to get them delivered to your
                    place. We offer free shipping on all the used parts of cars.</p>
                <button>TALK TO OUR EXPERT</button>
            </div>
            <div class="rightPage" style="background-image:url('../images/volv-car.png')">
        ...
        <div class="pageCont">
            <div class="leftPage">
                <p>
                    Vast reach to salvage yards
                </p>
                <p>
                    Whether you own an old car model or need an auto part that is not in production in the market now,
                    we provide auto parts for any car model and of all types to the clients as we have an extensive
                    network of prominent salvage yards in the country. We source the used auto parts from them, and test
                    and diagnose them with leakages and functioning.
                </p>
                <p>
                    Volkswagen car parts near me is the common query to resolve which we have our inventories opened in
                    all the cities in the USA for the faster accessibility of the auto parts. After the testing of the
                    auto parts, they are sent to inventories from where they are delivered. This vast and fast
                    availability of the product is the uniqueness served by us to the car owner which makes us capable
                    of standing out in the automobile market. Volkswagen car parts from USA Auto Parts are capable of
                    enhancing the performance of the car and providing a smooth driving experience.
                </p>
                <p>Our clients from across the USA have responded positively after getting the used car parts from us.
                    Volkswagen cars represent comfort and luxury and we promise you do not have to compromise on both
                    with the used Volkswagen parts. Search any car part by filling out the form with the information, go
                    through the reviews, and book it now.</p>


            </div>
            <div class="rightPage" style="background-image:url('../images/volc.png')">

            </div>
        </div>
        <!-- Tile -->
        <div class="TileCont" style="background-image:url('../images/hyndai_new.jpg')">
            <div class="tileParent">
                <div class="tileDiv">
                    <p>Brief about Volkswagen</p>
                    <p>
                        Surprisingly, Volkswagen was founded by a labor front named the German Labour Front in 1937. It
                        is a German automobile manufacturing company. It is the largest automobile producer with the
                        largest market in China. It sells 40 percent of cars to China only. Volkswagen's name comes from
                        two words; Volks and wagen meaning people's car. Its headquarters is in Wolfsburg, Lower Saxony,
                        Germany. Volkswagen owns these car brands: Porsche, Lamborghini, Bentley, Audi, Bugatti, Škoda,
                        SEAT, Scania and MAN. It became the third largest car manufacturer in the world in 2008 and has
                        a record of selling 6.29 million vehicles in the year 2010.
                    </p>
                </div>
            </div>
        </div>
