...
<div style="width:100%;height:100%;overflow-x:hidden;">
    ...
    <div class="tailHeader">
        <span><a href="../index.php">Home</a>/<span>Toyoto</span></span>
    </div>
    <!-- form -->
    <div class="formCont">
        <div class="leftForm">
        ...
        <div class="rightForm">
            <p>OEM Verified Used Toyota Parts and Accessories For Sale</p>
            <div class="iconTable">
                <div>
                ...
                <div class="btns">
                    <button>
                        ...
                        <span><a href="../order-now.php">Order now</a></span>
                    </button>
                    <button>
    ...
    <div class="pageCont">
        <div class="leftPage">
            <p>
                Get Most Durable, Top-Quality Used Toyota Parts For Sale
            </p>
            <p>
                Are you looking for low-cost Toyota auto parts for replacement? Get any of the auto parts of any
                model and make years from Usa Auto Parts. Auto parts like transmissions, engines, ABS Modules, transfer
                cases, cylinder heads, airbags, etc. are available for sale in the Usa Auto Parts to upgrade your big
                toy.
            </p>
            <p>
                No matter what these parts are made of, after a time they start wearing out and need maintenance. If
                the auto parts can be repaired easily, it’s best. But if they need to be replaced, then used Toyota
                parts are the best alternative as they are cost-effective and easily available. You can book them
                very easily and get them delivered to your no location in no time.
            </p>
            <button>TALK TO OUR EXPERT</button>
        </div>
        <div class="rightPage" style="background-image:url('../images/toyota-car.png')">
    ...
    <div class="pageCont">
        <div class="leftPage">
            ...
            <p>
                Toyota Motor Corporation is a Japan-based automotive company. It was founded in 1937 by Kiichiro
                Toyoda. It produces more than 10 million vehicles every year and set a world record with this
                milestone.
            </p>
            <p>
                The first auto part made by Toyota was a Type A engine in 1934 and its first car was Toyota AA, a
                passenger car launched in 1936. Production of Toyota in 2023 reached 300 million. It is the
                ninth-largest company in the world and the fourth-largest car manufacturer in the USA.
            </p>
            <p>Toyota is known for its superior and extreme performance with comfort and durability in its model
                vehicles. The long-lasting automotive parts of the Toyota made it more popular among the car
                enthusiasts.</p>

        </div>
        <div class="rightPage" style="background-image:url('../images/toyota-arts.webp')">

        </div>
    </div>
    <!-- Tile -->
    <div class="TileCont" style="background-image:url('../images/brandBg1.webp')">
        <div class="tileParent">
            <div class="tileDiv">
                <p>Fastest delivery on Used Toyota Engines</p>
                <p>
                    Usa Auto Parts is the trusted used auto part dealer in the USA with hundreds of inventories across
                    the
                    USA. These inventories help us deliver the requested auto parts to all the areas in the USA. Our
                    inventories are filled with the auto parts of all the brands, makes, and models. So we are
                    capable
                    of providing fast delivery service to our clients. Buyers searching for used Toyota Parts near
                    me
                    can get them without any effort in just one click. Fill up the form with the information of the
                    auto
                    part, make, and model, and get it at your place.
                </p>
            </div>
        </div>
    </div>
