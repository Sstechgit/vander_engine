...
<body>
    <div style="width:100%;height:100%;overflow-x:hidden;">
        ...
        <div class="tailHeader">
            <span><a href="../index.php">Home</a>/<span>Audi</span></span>
        </div>
        <!-- form -->
        <div class="formCont">
            <div class="leftForm">
            ...
            <div class="rightForm">
                <p>Used Audi Parts For Sale With OEM Specifications</p>
                <div class="iconTable">
                    <div>
                    ...
                    <div class="btns">
                        <button>
                            <a href="order-now.php"><i class="fa-solid fa-car"></i>
        ...
        <div class="pageCont">
            <div class="leftPage">
                <p>
                    Used Audi Parts: Best High Warranty Replacement
                </p>
                <p>
                    Audi, known for its excellent performance and semi-automotive featured cars consists of automotive
                    parts with high warranty and quality, but every machine once gets damaged and may need replacement
                    too. If you own Audi cars and need replacement of any damaged Audi parts, USA Auto Parts provides
                    the best quality used Audi parts for sale. All the used parts in our store are qualified and
                    high-performing. If you are seeking low-cost used Audi parts near me, we are the best place to get
                    one.
                </p>
                <button>TALK TO OUR EXPERT</button>
            </div>
            <div class="rightPage" style="background-image:url('../images/audi1.jpg')">
        ...
        <div class="pageCont">
            <div class="leftPage">
                ...
                <p>
                    Buyers may think that it can be risky to get second-hand Audi parts but do you know that the
                    pre-used parts provide better mileage? Yes, you read it right. Used auto parts consume less fuel and
                    hence provide improved mileage.
                </p>
                <p>
                    Secondly, It is available easily and at a low price. Buying used audi parts is a money-saving deal.
                    Lastly, used auto parts provide better performance. Due to its regular usage, it also provides
                    smoothness to drive.
                </p>


            </div>
            <div class="rightPage" style="background-image:url('../images/audiBg.jpg')">

            </div>
        </div>
        <!-- Tile -->
        <div class="TileCont" style="background-image:url('../images/audibg1.jpg')">
            <div class="tileParent">
                <div class="tileDiv">
                    <p>Finding used Audi Parts:</p>
                    <p>
                        Used Audi parts are available in many online stores. USA Auto Parts is also offering used Audi
                        parts in its online store. Buying used Audi parts online is a better option than searching for
                        them in markets. USA Auto Parts delivers used Audi parts nationwide with free shipping. Also, no
                        core charge will be demanded for 30 days and no hidden fee will be charged. We are a verified
                        auto part dealer with huge customers So if you are searching for used Audi Parts for sale near
                        me, then get it delivered quickly to your place.
                    </p>
                </div>
            </div>
        </div>
