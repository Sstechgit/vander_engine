...
<?php include "../popup.php"?>
    ...
    <?php include "../header/header.php"; ?>
        ...
        <div class="tailHeader">
            <span><a href="../index.php">Home</a>/<span>Honda</span></span>
        </div>
        <!-- form -->
        <div class="formCont">
            <div class="leftForm">
            ...
            <div class="rightForm">
                <p>Ecofriendly Used Honda Parts For Sale</p>
                <div class="iconTable">
                    <div>
        ...
        <div class="pageCont">
            <div class="leftPage">
                <p>
                Industry Best Standard Used Honda Parts For Sale
                </p>
                <p>
                Car owners often need clarification about getting used auto parts from Honda for replacement because used Honda parts are available at low prices, but what if they do not function well or will sit on the industry's best standards? Well, it depends on the source you are getting the counterparts. If you get them from any random vendor, then you may be disappointed. It may be troublesome until you get to us. We, USA Auto Parts are the USA’s best place to interchange dysfunctional Honda machine parts with their working eco-friendly counterparts.
                </p>
                <button>TALK TO OUR EXPERT</button>
            </div>
            <div class="rightPage" style="background-image:url('../images/honda1.png')">
        ...
        <div class="pageCont">
            <div class="leftPage">
                <p>
                About Used Honda Parts for Sale
                </p>
                <p>
                Honda Motors is a Japanese Multinational Automobile manufacturer that creates automobiles from motorbikes to aircraft. It is headquartered in Minato, Tokyo, Japan. From the year 1959, Honda was considered the largest manufacturer of bikes in the world and produced around 500 million motorbikes till 2024. It has also been named the record for producing the highest quantity of internal combustion engines. Honda makes around 14 million engines annually.
                </p>
                <p>In 1986, it was the eighth largest automobile manufacturer in the world which in 2001 ranked to second position.</p>
                <p>Honda was the first Japanese auto manufacturer to launch the luxury brand Acura in 1986. It located its plants in many countries like the United States of America, Japan, Canada, England, India, Pakistan, China, Belgium, Philippines, Mexico, Argentina, Peru, Taiwan, Turkey, Brazil, Vietnam, New Zealand, and Malaysia. In addition to its core automobile and motorcycle businesses, Honda also produces:</p>
               

            </div>
            <div class="rightPage" style="background-image:url('../images/hondaLogo.jpeg')">
        ...
        <div class="TileCont" style="background-image:url('../images/honda-bg.png')">
            <div class="tileParent">
                <div class="tileDiv">
                    <p>Sourcing auto parts from known junkyards:</p>
                    <p>
                    USA Auto Parts has a dealership with multiple used Honda parts junkyards for sourcing the potential auto parts from scrapped vehicles. Junk yards are the place where the scrapped vehicles are collected for disposal. We procure the counterparts which are in operating condition from them. After the quality testing and treatment by the expert team, we distribute them to inventories for selling.
                    </p>
                </div>
            </div>
        </div>
