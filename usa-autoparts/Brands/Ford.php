...
<?php include "../popup.php"?>
    ...
    <?php include "../header/header.php"; ?>
        ...
        <div class="tailHeader">
            <span><a href="../index.php">Home</a>/<span>Ford</span></span>
        </div>
        <!-- form -->
        <div class="formCont">
            <div class="leftForm">
            ...
            <div class="rightForm">
                <p>Used Ford Parts For Sale With Best Features</p>
                <div class="iconTable">
                    <div>
        ...
        <div class="pageCont">
            <div class="leftPage">
                <p>
                Top-Notch Quality Used Ford car Parts For Sale With Warranty
                </p>
                <p>
                Used Ford parts for sale are the best replacement for the damaged Ford automotive parts. If you are constantly experiencing any mechanical issues while driving and looking for the best replacement then used auto parts are worth it.
                </p>
                <button>TALK TO OUR EXPERT</button>
            </div>
            <div class="rightPage" style="background-image:url('../images/ford1.png')">
        ...
        <div class="pageCont">
            <div class="leftPage">
                <p>
                About Used Ford Parts for Sale
                </p>
                <p>
                Henry Ford founded Ford in 1903 in the United States. It is an automotive industry that produces cars, trucks, and other vehicles. In addition, they also created the engines used in Ford cars and other branded vehicles. It has built around 130 petrol and diesel engines in all these years with various updates and better specifications.
                </p>
                <p>We can get the used Ford car parts online. Online stores offer many saving deals and also provide delivery options. Stores like USA Auto Parts are the best place for online shopping of used car parts. USA Auto Parts is the USA's best online dealer for pre-owned automotive parts. You can get the used auto parts of any make and model from us. We are offering nationwide delivery services with free shipping. USA Auto Parts is the perfect store to get replacement auto parts quickly. If you are searching for used Ford parts near me you can get them delivered to your place from the stores like USA Auto Parts.:</p>
               

            </div>
            <div class="rightPage" style="background-image:url('../images/fordBg.png')">

            </div>
        </div>
        <!-- Tile -->
        <div class="TileCont" style="background-image:url('../images/ford-ng.png')">
            <div class="tileParent">
                <div class="tileDiv">
                    <p>Why choose us:</p>
                    <p>
                    USA Auto Parts offers tested used auto parts. We source salvaged auto parts from a reliable and known junkyard. Scrap vehicles here consist of auto machines that can be used again. We procure these parts from the vehicle and after that, they are checked if they function well, and are not damaged or leaking. After the inspection, they are availed from the reselling.
                    </p>
                    <p>We offer used auto parts at the lowest possible prices. We compare the market prices and offer the best deal to the customers.</p>
                    <p>We offer free shipping on all used Ford auto parts. Plus, we deliver the used parts to all the locations in the USA.</p>
                    <p>We offer a return and refund policy on used Ford parts in all areas.</p>
                </div>
            </div>
        </div>
        <!-- Faq -->
