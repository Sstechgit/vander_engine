...
<?php include "../popup.php"?>
    ...
    <?php include "../header/header.php"; ?>
        ...
        <div class="tailHeader">
            <span><a href="../index.php">Home</a>/<span>Hyundai</span></span>
        </div>
        <!-- form -->
        <div class="formCont">
            <div class="leftForm">
            ...
            <div class="rightForm">
                <p>Ready, Get Set, and Go With Hyundai Used Parts</p>
                <div class="iconTable">
                    <div>
        ...
        <div class="pageCont">
            <div class="leftPage">
                <p>
                Get Thrilling Experience With Hyundai Used Auto Parts
                </p>
                <p>
                If you are facing problems while driving and find any part of your Hyundai car worn out, you need a replacement for that auto part. Your car needs the quality used Hyundai parts which are not that costly but also do not fail your expectations with performance.
                </p>
                <p>You have come to the right place if you are searching for Hyundai used parts near me on the internet for replacement. You can buy the top quality used Hyundai auto parts from us from USA Auto Parts. It is a USA-based auto parts supplier with an all-over USA delivery facility. We are availing of the high-quality Hyundai used parts for sale.</p>
                <p>As the best trusted and verified auto part dealer, we have all the Hyundai used auto parts for all the make and models. our inventory consists of a huge collection of other auto parts also. Our store has used and rebuilt parts for automotive vehicles. Rebuilt parts are also available at low prices. All the parts available in our store come with OEM specifications or beyond. OEM-specified parts are available with a warranty and high performance.</p>
                <button>TALK TO OUR EXPERT</button>
            </div>
            <div class="rightPage" style="background-image:url('../images/hyndai1.webp')">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="card service-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p>At Usaauto-parts we offer you 24*7 customer
        ...
        <div class="pageCont">
            <div class="leftPage">
                ...
                <p>
                Hyundai Motors is a South Korea-based automobile brand founded in 1967. it is headquartered in Seoul, South Korea, and maintains the largest automobile production facility in Ulsan, South Korea. Cortina was the first model car of the company, released in cooperation with the automobile company Ford. This facility's production capacity is 1.6 million units. Hyundai sells its vehicles in 193 countries and it was third-largest automaker in 2022 after Toyota and Volkswagen.
                </p>
                <p>
                We source the used auto parts from the junk yards containing scrap cars. We salvage the auto parts. Our technically expert team examined the auto parts we salvaged. After the inspection and leak check, they are sent to inventories. We have inventories in all the locations in the USA to provide the fastest and safest delivery to the client.
                </p>
               

            </div>
            <div class="rightPage" style="background-image:url('../images/hyundaiBg.jpg')">
        ...
        <div class="TileCont" style="background-image:url('../images/hyndai_new.jpg')">
            <div class="tileParent">
                <div class="tileDiv">
                    <p>Our services:</p>
                    <p>
                    If you later change your mind or order the wrong product, you can easily return it to us and your amount will be refunded to you. This option will be valid for the 30-days. Our dedicated customer service is available all the time for the clients.
                    </p>
                </div>
            </div>
        </div>
