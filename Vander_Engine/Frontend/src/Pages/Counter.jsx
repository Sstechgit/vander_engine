    ...
    <div className="counter py-2 my-4">
      <div className="container my-1 text-center ">
        <p className=" text-black fw-medium animate__animated animate__fadeInUp my-5">
          SS Tech Services is one of the leading Digital Marketing Agencies. We
        ...
        <div className="row mt-5 justify-content-around mb-5 m-0">
          ...
          >
            <img
              src="https://img.freepik.com/premium-vector/happy-client-customer-business-icon-feedback-client-positive-sign-smile-symbol_41737-777.jpg"
              alt=""
            />
            <h3
              style={{ color: "#0f5a6c", fontSize: "40px" }}
