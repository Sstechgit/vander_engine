...
export default function Update_Product() {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!formData.year || !formData.make || !formData.model || !formData.variant) {
        ...
        try {
            ...
            // Log the response to verify API response
            console.log('Response from API:', response.data);
    
            // If the API responds successfully, navigate
            ...
            <div className="container">
                ...
                <div className="row align-items-center justify-content-center">
                    <div className="col-lg-7 mb-4">
                        <form className="border p-4 border-info bg-white" onSubmit={handleSubmit}>
