    ...
    <div className="allparts">
      <div className="container">
        ...
        <div className="row justify-content-center">
          {data.map((item, index) => {
            return (
              <div className="col-lg-2 mb-5  col-6" key={index}>
                <div
        ...
        <p>
          Our comprehensive, alphabetized list of new car and truck parts is
          organized by part type, making it easy for you to find exactly what
          you're looking for. If you can’t find your part among our best
          sellers, you’re sure to discover it here. For a more customized
          search, select your vehicle above or complete your offering by
          browsing additional options.
        </p>
      </div> {/* Conditionally render the modal */}
      {modalOpen && (
