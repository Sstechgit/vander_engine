...
import styles from "./Engines_page.module.css";
import Footer from "../Home/Footer";
import engine from './images/engine.png';
import EnginePageFeatures from './EnginePageFeatures';
...
const Engine_QuoteForm = () => {
  ...
  return (
    <>
      ...
      {/* <Header /> */}
      <Container fluid className={styles["container_all"]}>
        <Row className={styles["form_row"]}>
          <Col md={6} sm={12} className={`${styles["form_column"]} ${styles["form-border"]}`}>
            <form onSubmit={handleSubmit}>
              <Row>
                <div className={styles["quote-container"]}>
                  {/* <h1>Search Your Engine</h1> */}
                </div>
                <Col md={6} sm={6} xs={6} className={styles["form_left side"]}>
                  <div className={styles["Engine-form-group"]}>
          ...
          <Col md={6} sm={12}>
            ...
            <div className={styles["image_text"]}>
              ...
              <h2>Low Cost & Free Shipping +1844-893-1760</h2>
            </div></Col>
        </Row>
        <StatsComponent className={styles["custom-box"]} />
      </Container>
      <Row className={styles["Engine_page_content"]}>
        <Col md={12} sm={12} >
          <div>
            <h1>About Our Engines</h1>
            <p>At Vander Engines Transmissions , We have high quality used engines
              these engines are sourced from the most trusted supplier.
              The remanufactured engines that we sell are highly tested and inspected,
              they give you high performance and efficiency. We sell second hand engines
              across the United states, catering to a wide variety of makes and models.
            </p>
            <p>Our used engines are carefully selected, rigorously tested, and inspected
              to ensure that they meet the highest performance standards. No matter whether
              you're looking for used   engines for cars, trucks, or SUVs, we provide reliable,
              affordable solutions that help extend the life of your vehicle while saving you
              money.</p>
          </div>
        </Col>
      </Row>
...
export default Engine_QuoteForm;
