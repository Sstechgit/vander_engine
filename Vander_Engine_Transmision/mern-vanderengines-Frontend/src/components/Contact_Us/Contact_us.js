import StatsComponent from '../Features/StatsComponent';
import Footer from '../Home/Footer';
import styles from './Contact_us.module.css'
import WhatOurCustomersSay from '../Home/CustomerTestimonials';
import LeadCaptureForm from '../Home/LeadCaptureForm';
import AboutUs from '../Home/Aboutus';
import FAQs from '../Home/FAQs'
import FreeConsultation from '../Forms/FreeConsultation';
import React, { useState } from "react";
import { Container, Row, Col } from "react-bootstrap";
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import engine_image1 from "./form/Engines/engine_main_1.png";
import engine_image2 from "./form/Engines/engine_main_2.png";
import engine_image3 from "./form/Engines/Transmission.png";
...
const Contact_us_page = () => {
  ...
  return (
    <>
      ...
      <Container className={styles["main_conatiner_all"]}>
        <Row className={styles["main_form_row"]}>
          <Col md={6} sm={12} className="main_form_column">
            <form onSubmit={handleSubmit}>
              <Row>
                ...
                <Col md={6} sm={6} xs={6} className={styles["main_form_left side"]}>
                  <div className={styles["main_headline-form-group"]}>
                ...
                <Col md={6} sm={6} xs={6} className={styles["form_right side"]}>
                  ...
                  {/* <div className="main_headline-form-group">
                ...
                <label className="">
                  ...
                  _text messages from
                  <span className=" mx-2" style={{ color: "#000" }}>     Vander Engines      </span>
          ...
          <Col md={6} sm={12} className={styles["headline_main_form_column_right"]}>
            <div className={styles["main_slider-container"]}>
              <div className={styles["main_slider"]}>
                <img src={engine_image1} alt="Transmission 1" className={styles["mani_slide-image"]} />
                <img src={engine_image2} alt="Transmission 2" className={styles["mani_slide-image"]} />
                <img src={engine_image3} alt="Transmission 3" className={styles["mani_slide-image"]} />
              </div>
            </div>
            <div className={styles["main_image_text"]}>
              <h1 className={styles["main_typing-text"]}>Used Engines and Transmissions</h1>
              <h1 className={styles["main_typing-text"]}>for Sale with a Warranty</h1>
