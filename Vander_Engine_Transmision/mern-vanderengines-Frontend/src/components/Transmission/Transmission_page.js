...
const QuoteForm_Transmission = () => {
  ...
  return (
    <>
      ...
      <div className="quoteform-transmission-wrapper">
        {/* <Header /> */}
        <Container className="tranmission_conatiner_all">
          <Row className="tranmission_form_row">
            <Col md={6} sm={12} className="tranmission_form_column_right">
              <div>
                <img src={tranmission} alt="transmission" className="img-fluid transmission" />
              </div>
            ...
            <Col md={6} sm={12} className="tranmission_form_column">
              <form onSubmit={handleSubmit}>
                <Row>
                  <div className="tranmission_quote-container">
                    <h1>Search Your Transmission</h1>
                  </div>
                  <Col md={6} sm={6} xs={6} className="tranmission_form_left">
        ...
        <Row className="Transmission_page_content">
          <Col md={12} sm={12}>
            <div>
