    ...
    if (sessionStorage.getItem("designation") == "Admin") {
      return (
        <ul className="menuList">
          <li style={current=="Admin_Home"?focusStyle:{}}
            onClick={() => {
          ...
          <li style={current=="tasks"?focusStyle:{}}
            onClick={() => {
              setCurrent("tasks")
              navigate("/crm/Task");
            }}
          ...
          <li style={current=="leads"?focusStyle:{}}
            onClick={() => {
              setCurrent("leads")
              navigate("/crm/Leads");
            }}
          ...
          <li style={current=="track"?focusStyle:{}} onClick={()=>{
            setCurrent("track")
          ...
          <li style={current=="agents"?focusStyle:{}}
            onClick={() => {
              setCurrent("agents")
              navigate("/crm/agents");
            }}
          ...
          <li style={current=="orders"?focusStyle:{}}
            onClick={() => {
              setCurrent("orders")
              navigate("/crm/Order");
            }}
          ...
          <li style={current=="client"?focusStyle:{}}
            onClick={() => {
              setCurrent("client")
              navigate("/crm/Client");
            }}
          ...
          <li style={current=="invoice"?focusStyle:{}}
            onClick={() => {
              setCurrent("invoice")
          ...
          <li style={current=="search"?focusStyle:{}} onClick={()=>{
            setCurrent("search")
      ...
      return (
        <ul className="menuList">
           <li style={current=="agent-home"?focusStyle:{}} onClick={()=>{
            setCurrent("agent-home")
            navigate("/crm/agent/Agent_Home")}}>
            <i class="fa-solid fa-house"></i>
            <span>Home</span>
          </li>
          <li style={current=="agent-task"?focusStyle:{}} onClick={()=>{
            setCurrent("agent-task")
            navigate("/crm/agent/Task")}}>
            <i className="fa-solid fa-list-check"></i>
            <span>Your Tasks</span>
          </li>
          <li style={current=="agent-follow"?focusStyle:{}} onClick={()=>{
          ...
          {/* pending contact */}
          <li style={current=="agent-won"?focusStyle:{}} onClick={()=>{
          ...
          <li style={current=="agent-client"?focusStyle:{}} onClick={()=>{
          ...
          <li style={current=="agent-calendar"?focusStyle:{}} onClick={()=>{
          ...
          <li style={current=="agent-email"?focusStyle:{}} onClick={()=>{
