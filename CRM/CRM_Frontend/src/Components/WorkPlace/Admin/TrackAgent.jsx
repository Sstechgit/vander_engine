  ...
  const columns = [
    {
      ...
      dataIndex: "id",
      width: 50,
      headerStyle: {  // Style for the header
      ...
      render: (text) => (
        <div style={{ textAlign: "center", fontSize: "16px ", fontWeight:"bolder" }}> {/* Custom style for cell */}
          {text}
        </div>
      )
    ...
    },
    {
      ...
      render: (text) => (
        <div style={{ textAlign: "center", fontSize: "16px " }}> {/* Custom style for cell */}
          {text}
        </div>
      )
    },
    ...
    },
    {
      ...
      dataIndex: "Closed",
      render: (_, record) => {
        return <AgentLead status={"Closed"} record={record} />;
      },
    },
  ];
